...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _domElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domElement */ \"./src/domElement.js\");\n/* harmony import */ var _mainProject__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mainProject */ \"./src/mainProject.js\");\n\n\n\nconst $project = document.querySelector('#task-container');\n\nclass Task {\n  constructor(title, description, dueDate, priority, status) {\n    this.title = title;\n    this.description = description;\n    this.date = dueDate;\n    this.priority = priority;\n    this.status = status;\n  }\n\n  render() {\n    const $div = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('div', this.id, ['task'], null);\n\n    const $divTaskName = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('div', null, ['task-name'], null);\n    const $divTaskDescription = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('div', null, ['task-descrption'], null);\n    const $checkbox = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('input', null, ['checkbox'], null);\n    $checkbox.type = 'checkbox';\n\n    const $p = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('p', null, null, this.title);\n    const $pi = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('p', null, null, this.description);\n\n    const $divTaskInfo = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('div', null, ['task-info'], null);\n    const $date = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('p', null, null, this.date);\n    const $badge = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('div', null, ['badge'], this.priority);\n    const $delete = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('img', null, ['delete'], null);\n    $delete.src = './img/delete.svg';\n    const $edit = (0,_domElement__WEBPACK_IMPORTED_MODULE_0__.createHtmlElement)('img', null, ['edit'], null);\n    $edit.src = './img/edit.svg';\n    $edit.addEventListener('click', () => {\n      this.edit();\n    });\n\n    $divTaskName.appendChild($checkbox);\n    $divTaskName.appendChild($p);\n\n    $divTaskDescription.appendChild($checkbox);\n    $divTaskDescription.appendChild($pi);\n\n    $divTaskInfo.appendChild($date);\n    $divTaskInfo.appendChild($badge);\n    $divTaskInfo.appendChild($delete);\n    $divTaskInfo.appendChild($edit);\n\n    $div.appendChild($divTaskName);\n    $div.appendChild($divTaskDescription);\n    $div.appendChild($divTaskInfo);\n\n    $project.appendChild($div);\n    $checkbox.addEventListener('change', () => {\n      $p.classList.toggle('done');\n    });\n    $project.appendChild($div);\n    $checkbox.addEventListener('change', () => {\n      $pi.classList.toggle('done');\n    });\n    if (this.priority === 'urgent') {\n      $badge.classList.add('urgent');\n    }\n\n    $delete.addEventListener('click', () => {\n      this.delete();\n    });\n  }\n\n  delete() {\n    _mainProject__WEBPACK_IMPORTED_MODULE_1__.currentProject.tasks = _mainProject__WEBPACK_IMPORTED_MODULE_1__.currentProject.tasks.filter(\n      (task) => task.id !== this.id,\n    );\n    _mainProject__WEBPACK_IMPORTED_MODULE_1__.currentProject.renderTasks();\n  }\n\n  edit() {\n    const $modal = document.getElementById('myModal');\n    $modal.style.display = 'flex';\n    const $form = document.getElementById('form-task-edit');\n    $form.addEventListener('submit', (e) => {\n      e.preventDefault();\n      const $title = document.getElementById('task-name-edit');\n\n      const $description = document.getElementById('task-description-edit');\n\n      const $date = document.getElementById('task-date-edit');\n\n      const $priority = document.getElementById('task-priority-edit');\n\n      this.title = $title.value;\n      this.description = $description.value;\n      this.date = $date.value;\n      this.priority = $priority.value;\n      $modal.style.display = 'none';\n      _mainProject__WEBPACK_IMPORTED_MODULE_1__.currentProject.renderTasks();\n    });\n  }\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Task);\n\n\n//# sourceURL=webpack://todo-list-js/./src/getTask.js?");
